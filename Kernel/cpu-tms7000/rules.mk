export CROSS_AS=fcc -mtms7000 -X -c
export CROSS_LD=ld7000
export CROSS_CC=fcc
export CROSS_CCOPTS= -X -mtms7000 -c -Os -I$(ROOT_DIR)/cpu-$(CPU) -I$(ROOT_DIR)/platform/platform-$(TARGET) -I$(ROOT_DIR)/include
