...
Generated by `fcc/mkstatus.py` on 2026-08-22. **Neither half is hand written**: the names come from MMBasic's own
...
**Commands:** `Astro`, `Backlight`, `Camera`, `CtrlVal(`, `Device`, `Gamepad`, `I2CLCD`, `Keyboard`, `LCD`, `Location`, `Mouse`, `SPI2`, `Star`, `TMC22xx`, `Wii`, `Wii Classic`, `Wii Nunchuck`
